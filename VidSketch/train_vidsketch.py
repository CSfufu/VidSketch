...
from VidSketch.models.unet import UNet3DConditionModel
from VidSketch.data.dataset import VidSketchDataset
from VidSketch.pipelines.pipeline_VidSketch import VidSketch
...
def main(
    ...
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    #unet = UNet3DConditionModel.from_pretrained('/'.join(my_model_path.split('/')[:-1]), subfolder=my_model_path.split('/')[-1]).to('cuda')
    ...
    train_dataset = VidSketchDataset(**train_data)
    ...
    if accelerator.is_main_process:
        ...
        pipeline = VidSketch.from_pretrained(
